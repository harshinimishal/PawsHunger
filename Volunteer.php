...
<body class="bg-blue-50 font-sans">
    ...
    <section id="google-form-section" class="py-10 bg-white hidden-form">
        ...
        <div class="mt-8 mx-auto max-w-5xl">
            <iframe id="google-form" src="" width="100%" height="400" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
        </div>
    </section>
    ...
    <!-- Google Form Display Script -->
    <script>
        function showGoogleForm(formId) {
            let formUrls = {
                'form1': 'https://docs.google.com/forms/d/e/1FAIpQLSeqDccC1qdNh62ADa2mKdkcQw4NFN0SjB2nzHatPXPZFYvu8A/viewform?embedded=true',
                'form2': 'https://docs.google.com/forms/d/e/1FAIpQLScGeneralForm/viewform?embedded=true',
                'form3': 'https://docs.google.com/forms/d/e/1FAIpQLScRabiesDriveForm/viewform?embedded=true',
                'form4': 'https://docs.google.com/forms/d/e/1FAIpQLScPRCreativesForm/viewform?embedded=true'
            };

            document.getElementById('google-form').src = formUrls[formId];
